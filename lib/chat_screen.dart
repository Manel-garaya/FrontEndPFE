...
//       Uri.parse('http://192.168.73.164:8080/chats'),
...
//     final response = await http.get(Uri.parse('http://192.168.73.164:8080/chats?userId=$userId'));
//     if (response.statusCode == 200) {
...
//   //       'http://192.168.73.164:8080/chats/conversation/${widget.senderId}/${widget.recipientId}'));
//   //   if (response.statusCode == 200) {
//   //     final List<dynamic> responseData = jsonDecode(response.body);
//   //     setState(() {
//   //       messages =
